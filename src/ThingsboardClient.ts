...
import { AssetProfileService } from './service/AssetProfileService';
...
export class ThingsboardClient {
    ...
    private deviceProfileService: DeviceProfileService | null = null;
    private assetProfileService: AssetProfileService | null = null;
    ...
    public getDeviceProfileService(): DeviceProfileService {
        if (!this.deviceProfileService) {
            this.deviceProfileService = new DeviceProfileService(this);
        }
        return this.deviceProfileService;
    }

    public getAssetProfileService(): AssetProfileService {
        if (!this.assetProfileService) {
            this.assetProfileService = new AssetProfileService(this);
        }
